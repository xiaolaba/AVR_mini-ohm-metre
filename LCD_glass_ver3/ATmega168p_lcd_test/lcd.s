...
__zero_reg__ = 1
 ...
 ;  c:\winavr-20100110\bin\../lib/gcc/avr/4.3.3/ lcd.c -mmcu=atmega168p
...
.L13:
	...
	ld r30,Z	 ;  D.1228,
	mov r24,r30	 ;  tmp85, D.1228
	subi r24,lo8(-(-48))	 ;  tmp85,
	cpi r24,lo8(10)	 ;  tmp85,
	brsh .L2	 ; ,
	ldi r31,lo8(0)	 ;  D.1228,
	subi r30,lo8(-(number-48))	 ;  D.1228,
	sbci r31,hi8(-(number-48))	 ;  D.1228,
	rjmp .L16	 ; 
.L2:
	mov r24,r30	 ;  tmp90, D.1228
	subi r24,lo8(-(-65))	 ;  tmp90,
	cpi r24,lo8(6)	 ;  tmp90,
	brsh .L4	 ; ,
	ldi r31,lo8(0)	 ;  D.1228,
	subi r30,lo8(-(number-55))	 ;  D.1228,
	sbci r31,hi8(-(number-55))	 ;  D.1228,
	rjmp .L16	 ; 
.L4:
	mov r24,r30	 ;  tmp95, D.1228
	subi r24,lo8(-(-97))	 ;  tmp95,
	cpi r24,lo8(6)	 ;  tmp95,
	brsh .L3	 ; ,
	ldi r31,lo8(0)	 ;  D.1228,
	subi r30,lo8(-(number-87))	 ;  D.1228,
	sbci r31,hi8(-(number-87))	 ;  D.1228,
.L16:
	ld r23,Z	 ;  Show_Char, number
.L3:
	mov r22,r23	 ;  D.1236, Show_Char
	sbrs r23,0	 ;  D.1236,
	rjmp .L5	 ; 
